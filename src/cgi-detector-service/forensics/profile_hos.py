...
def run_hos_analysis():
    ...
    # Call the analyze_hos function
    analyze_hos(image_bytes)

if __name__ == "__main__":
    profile_output_path = "hos_profile.prof"
    cProfile.run('run_hos_analysis()', profile_output_path)
